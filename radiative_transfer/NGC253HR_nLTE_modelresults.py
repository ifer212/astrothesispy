...
def load_observed_LTE(NGC253_path, source, results_path, fig_path, fort_paths, plot_LTE_lum = False):
    ...
    return obs_df, new_hb_df, cont_df
...
if plot_cont:
    ...
    d05_base0 = f'{NGC253_path}SHC/{source}/Madextracted_220_nocontsub_v2/distpc_0p05/origbeam_SMaver/origbeam_SMaver/01_NGC_253_237_BASE0'
    ...
    d55_base0 = f'{NGC253_path}SHC/{source}/Madextracted_220_nocontsub_v2/distpc_0p55/origbeam_SMaver/origbeam_SMaver/01_NGC_253_237_BASE0'
